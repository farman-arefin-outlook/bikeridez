            ...
            <Container>
                <Zoom>
                    <h2 className="text-center text-black mb-4">
                        WELCOME TO REACH TRAVEL INCORPORATED
                    </h2>
                </Zoom>
                <Row>
                    <Col md className="pe-3">
                        <Bounce bottom>
                            ...
                            <p className="text-muted">
                                ...
                                Item completion rate in the industry.
                            </p>
                            <p className="text-muted">
                                And the reason is, we don’t give up. When a student commits to a
                                Item, we commit to the student. We are not going to sugar coat
                    ...
                    <Col md className="pe-3">
                        <Bounce bottom>
                            ...
                            <p className="text-muted">
                                ...
                                continue and complete Items by attending live online Items,
